...
const BlogListPage: React.FC = () => {
  ...
  const featuredPosts = [
    ...
    },
    {
      ...
      author: {
        name: 'Sanjay Gupta',
        role: 'CFO',
        bio: 'Financial strategist with expertise in heavy equipment industry economics',
        avatar: 'https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=150&h=150&q=80'
      },
      column: 'Investor Relations',
      date: '2024-07-10',
      readTime: '12 min',
      likes: '4.5K',
      comments: '289',
    ...
    },
    {
      ...
      excerpt: 'Breaking down TILs latest financial results and what they mean for investors',
      author: {
        name: 'Neha Kapoor',
        role: 'Financial Analyst',
        bio: 'Specializing in heavy equipment sector financial analysis and forecasting',
      ...
      likes: '3.2K',
      comments: '178',
      image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&h=600&q=80',
      thumbnail: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=150&h=150&q=80',
      featuredImage: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&h=628&q=80',
      tags: ['Earnings', 'Financials', 'Report']
    }
  ];
  ...
  const handlePostClick = (postTitle: string) => {
    navigate(`/media/blog/${postTitle.replace(/\s+/g, '-').toLowerCase()}`);
  };
  ...
  <img
    src={`${IMAGE_BASE}/blogpage-bg.jpg`}
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-10 xl:px-20 py-16 -mt-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                  ...
                  <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                    ...
                    <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                      ...
                      >
                        ...
                        <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                          <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l4.5 4.25a.75.75 0 01-1.04 1.08L11.168 10l3.938 3.71a.75.75 0 11-1.04 1.08l-4.5-4.25a.75.75 0 010-1.08l4.5-4.25a.75.75 0 011.06.02z" clipRule="evenodd" />
                        </svg>
                      </button>
                    </nav>
                  </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-gradient-to-r from-[#F1B434] to-[#FFE352] rounded-xl shadow-sm p-6 mt-8 text-white">
